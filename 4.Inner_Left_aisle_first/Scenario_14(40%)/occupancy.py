...
file_2 = r"C:\Users\ongwe\Documents\ITP Job\Coding\4.Inner_Left_aisle_first\Scenario_14(40%)\final_list.csv"  
...
def check_occupancy():
    ...
    for bay_id, aisle_id, level_id, pallet_id in id_list:
        if 1 <= bay_id <= max_bay and 1 <= aisle_id <= max_aisle and 1 <= level_id <= max_level:
            occupancy_grid[bay_id-1][aisle_id-1][level_id-1] = (1, pallet_id)
