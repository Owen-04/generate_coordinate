...
# 1 -> 4 -> 2 -> 3
# A -> D -> B -> C
filename = r"C:\Users\ongwe\Documents\ITP Job\Coding\4.Inner_Left_aisle_first\Scenario_19(90%)\export.csv"
generated_list = []
max_bay = 56
max_aisle = 24
max_level = 10
...
def generate():
    ...
    total_per_zone = int(0.9 * max_bay * aisle_per_zone * max_level) 
