...
# 1 -> 4 -> 2 -> 3
# A -> D -> B -> C
filename = r"C:\Users\ongwe\Documents\ITP Job\Coding\4.Inner_Left_aisle_first\Scenario_17(70%)\export.csv"
generated_list = []
max_bay = 56
max_aisle = 24
max_level = 10
...
def generate():
    ...
    total_per_zone = int(0.7 * max_bay * aisle_per_zone * max_level) 
...
def combine_list():
    ...
    outer_count = 0
    inner_count = 0
    while outer_count < len(outer_list) and inner_count < len(inner_list):

    
        combined_list.append(outer_list[outer_count])
        combined_list.append(outer_list[outer_count + 1])
        outer_count= outer_count + 2
        
        combined_list.append(inner_list[inner_count])
