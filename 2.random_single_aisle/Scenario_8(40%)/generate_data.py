...
filename = r"C:\Users\ongwe\Documents\ITP Job\Coding\2.random_single_aisle\Scenario_8(40%)\export.csv"
generated_list = []
max_bay = 56
max_aisle = 24
max_level = 10
...
def generate():
    total = int((max_level * max_bay) * 0.4)
    ...
    for aisle_id in range(1,max_aisle+1):
        ...
        while len(temp_list) < total:
            ...
            if id_tuple not in generated_list and id_tuple not in temp_list:
                generated_list.append(id_tuple)
                temp_list.append(id_tuple)
