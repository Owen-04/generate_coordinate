...
filename = r"C:\Users\ongwe\Documents\ITP Job\Coding\2.random_single_aisle\Scenario_11(70%)\export.csv"
generated_list = set()
max_bay = 56
max_aisle = 24
max_level = 10
...
def generate():
    total = int((max_level * max_bay) * 0.7)
